package com.zealzhangz.redisclusterdemo.redis.service.impl;

import com.zealzhangz.redisclusterdemo.redis.model.RedisVo;
...
public class RedisClusterServiceImpl implements RedisService {
    ...
    @Override
    public void save(RedisVo redisVo, long exp) {
        redisTemplate.opsForValue().set(redisVo.getKey(),redisVo.getValue(),exp, TimeUnit.SECONDS);
    }
